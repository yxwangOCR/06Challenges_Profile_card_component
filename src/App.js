...
function App() {
  return (
    <>
      <img
        class='fixed top-[3rem] left-[-15rem] sm:left-[-25rem] sm:top-[-3rem] lg:top-[-20rem] lg:left-[-30rem] xl:left-[-20rem] tg:left-[-15rem] -z-10 overflow-hidden'
        src={bgTop}
      ...
      <img
        class='fixed top-[40rem] left-[15rem] sm:left-[20rem] lg:left-[25rem] xl:left-[30rem] tg:left-[40rem] -z-10 overflow-hidden'
        src={bgBottom}
